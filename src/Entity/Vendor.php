...
class Vendor implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?string $appointmentDuration = null;
    ...
    public function getAppointmentDuration(): ?string
    {
        return $this->appointmentDuration;
    }
    public function setAppointmentDuration(?string $appointmentDuration): self
    {
